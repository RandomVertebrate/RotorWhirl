...
modes = 17;         % Number of assumed modes (higher = more accurate and slower)
plotres = 41;       % Resolution of Campbell diagram (increase if diagram looks garbled)
modespeeds = 5;    % Number of speeds to draw modeshapes at
maxnodes = 4;
max_num_modeshapes = 9;
...
% Updated bearing parameter
C1 = 230.571424;        % Curve-fitted bearing constant
C2 = 14112611380.972; % Curve-fitted bearing constants
C3 = 2.035349;          % Curve-fitted bearing constants
...
Airgapvalues = 55:70;            % airgapvalues
...
kblist = [5e6 5e6];       %in N/m
%kblist = [1e5 1e5 1e5 1e5 1e5];       %in N/m
